    ...
    <div class="wrapper">
        ...
        <div class="main-panel">
            ...
            <div class="content">
                <div class="container-fluid">
                  <div class="col-md-3">  
                    <button type="button"  class='btn btn-danger' id="btn_add" data-toggle="modal"><i class='fa fa-user'></i>&nbsp;&nbsp;Add Handler</button>
                  </div> 
                          ...
                          <div class="modal-dialog modal-lg">
                            <div class="modal-content">
                               ...
                               <div class="modal-header bg bg-primary">
                                 ...
                                 <h3><i class='fa fa-user'></i>&nbsp;Add Handler</h3>
                               </div>
                                       ...
                                       <div class="col-md-12" style="padding-bottom:20px"> 
                                        ...
                                        <div class="col-md-12">
                                          <br><br><br><br><br>
                                           ...
                                           <button type="button" id="btn_addHandler"  class="btn pull-right">Add</button>
                                        </div>   
                                   </div> 
                                 </div>
                        ...
                        <div class="col-md-12">
                            <div class="card">
                                <div class="card-header" data-background-color="red">
                                    <h4 class="title">Handler List</h4>
                                    <p class="category"></p>
                                </div>
                                <div class="card-content table-responsive">
                                    <table class="table" id="tbl_handler_list">
                                              <tr>
    ...
    <div class="modal fade" id="myDogs">
       <div class="modal-dialog modal-lg">
         <div class="modal-content">
             <div class="modal-header">
                 <button type="button" class="close" data-dismiss="modal">&times;</button>
                 <input type="text" id="handler_id" style="display:none">   
             </div>
             <div class="modal-body">
                <table class="table">
                  <tr class="bg bg-primary">
 ...
 <script>
   ...
   $(document).ready(function(){
             ...
             $("#btn_add").click(function(){
               ...
               var tblHandlers = document.getElementById('tbl_handler_list');
                          var dbref = firebase.database().ref('User').child('Handlers');
                          var rowIndex = 1;
               ...
               dbref.on('value',function(snapshot){
                  snapshot.forEach( function(childSnapshot) {
                         ...
                         var cellBD             = row.insertCell(5);
                        // var cellContact        = row.insertCell(6);
                         //var cellPosition       = row.insertCell(6);
                         var cellEdit           = row.insertCell(6); 
                         var cellDel            = row.insertCell(7);
                         var cellAssign         = row.insertCell(8);
                         var cellViewMyDogs     = row.insertCell(9);
                            ...
                            cellBD.appendChild(document.createTextNode(childData.Birthdate));  
                            //cellContact.appendChild(document.createTextNode(childData.Contact_Number));
                            // cellPosition.appendChild(document.createTextNode(childData.Position)); 
                              ...
                              // btnEdit.setAttribute("data-target", "#modalID");
                            ...
                            var btnAssign = document.createElement("BUTTON");
                              ...
                              cellViewMyDogs.appendChild(btnViewMyDogs);
                               ...
                               $("#viewMyDog-"+childKey).click(function(){
                                   $("#handler_id").val(childKey);
                                   $.getJSON("https://searchand-f8856.firebaseio.com/User/Handlers/"+childKey+"/Assigned_Dogs.json", function(data){
                     ...
                     $.each(snapshot,function(key,val){
                         ...
                         function deleteInfo(id)
                         {
                               alertify.confirm('Message','Are you sure you want to remove this handler ?', function(){ 
                                         var ref = firebase.database().ref('User').child('Handlers').child(id);
                                          ref.remove()
                                          .then(function(){
              ...
              $("#btn_addHandler").click(function(){                    
                  ...
                  if(emailResult==true &&  numberResult==true &&(pass == repas) && fname.length!=0 && mname.length!=0 && lname.length!=0 && add.length!=0 && bd.length!=0 && (no.length>10)&& age.length!=0)
                  {
                            ...
                            firebase.auth().createUserWithEmailAndPassword(email, pass).then(function() {
                               ...
                               var current_user_db = firebase.database().ref('User').child('Handlers/'+user);
                              current_user_db.set({
                                 Address:add,
                                 Age:age,
                                 Contact_Number:no,
               ...
               $("#btn_update").click(function(){
                              ...
                              var cp    =    $("#cp").val();
                              var age   =    $("#age").val();
                              firebase.database().ref('User').child('Handlers/' +id)
                               .update({ 
                                   firstname: fname, 
                                   middlename:mname,
                                   lastname:lname,
...
<script type="text/javascript">
  ...
  function removeMyDog(dogUID){
      var handerUID = $("#handler_id").val();
      var handlerref = firebase.database().ref('User').child('Handlers').child(handerUID).child('Assigned_Dogs').child(dogUID);
                 handlerref.remove()
                .then(function(){
                     console.log("Remove succeeded");
                })  
      ...
      $.getJSON("https://searchand-f8856.firebaseio.com/Dog/"+id+".json",function(data){
            ...
            var mchip = data['Microchip'];
                alertify.confirm('Message','Are you sure you want to assign this dog ?', function(){ 
                       var dbhandlerref = firebase.database().ref('User').child('Handlers').child(handlerUID);
